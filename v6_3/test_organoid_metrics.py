...
# [DÜZELTME — bkz. proje notları] Önceden yazarın kendi geliştirme
# makinesine özel, taşınamaz bir mutlak yol vardı (/tmp/axon_final/v6_3).
# Testler zaten organoid_metrics.py ile aynı klasörde olduğu için Python
# bunu otomatik bulur, ama bu satır başka bir makinede path'i YANLIŞ bir
# dizine sessizce ekleyip kafa karıştırabilirdi. Artık dosyanın kendi
# konumuna göre taşınabilir.
