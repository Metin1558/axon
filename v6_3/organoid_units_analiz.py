...
def main():
    ...
    if not os.path.exists(args.dosya):
        print(f'ERROR: File yok: {args.file}')
        return 1
    ...
    if not units:
        ...
        if secim == '1':
            ...
            try:
                ...
                print(f'  Kayit suresi: {sure_s:.1f} s')
                print()
                ...
                print(f'  Kayit suresi: {sure_s:.1f} s ({sure_s/60:.1f} min)')
                print()
    ...
    print(f'  Active (>={args.min_spike} spike): {active_unit_sayi} unit')
    print()
    ...
    if sttc_sonuc:
        print(f'  Median STTC: {sttc_sonuc["median_sttc"]:.3f}')
    ...
    print('=' * 60)
    print(f'  Kayit suresi    : {sure_s:.1f} s ({sure_s/60:.1f} minute)')
    print(f'  Total unit     : {len(units)}')
    print(f'  Active unit      : {active_unit_sayi} '
    ...
    if sttc_sonuc:
        print(f'    Median STTC  : {sttc_sonuc["median_sttc"]}')
